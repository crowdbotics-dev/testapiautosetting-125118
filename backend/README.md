...
## Project Structure
    ...
    ├── testapiautosetting_125118  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125118`
...
2. Clone this repo and `cd testapiautosetting_125118`
